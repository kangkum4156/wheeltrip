...
class FeedbackOptionButton extends StatefulWidget {
  final List<String> selectedFeatures;
  final ValueChanged<List<String>> onFeaturesChanged;
  final bool isEditable;

  const FeedbackOptionButton({
    super.key,
  ...
  @override
  State<FeedbackOptionButton> createState() => _FeedbackOptionButtonState();
}

class _FeedbackOptionButtonState extends State<FeedbackOptionButton> {
  final List<Map<String, dynamic>> _defaultOptions = [
    {"label": "엘리베이터", "icon": Icons.elevator},
    {"label": "경사로", "icon": Icons.stairs},
    {"label": "휠체어 가능", "icon": Icons.accessible},
  ];
  ...
  Widget build(BuildContext context) {
    final visibleOptions = widget.isEditable
        ...
        : _selected; // view 모드에서는 선택된 것만 표시
